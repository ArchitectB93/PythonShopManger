...
def GenerateBill():
    ...
    if p1quantity.get() == 0 and p2quantity.get() == 0 and p3quantity.get() == 0 and p4quantity.get() == 0:
        ...
        if p1quantity.get() != 0:
            ...
            (?, ?, ?, ?,?)
            '''
            cur.execute(sql, (dateE.get(), 'Product-1',
                        p1pirce.get(), p1quantity.get(), price))
            connectObj.commit()
        ...
        if p2quantity.get() != 0:
            ...
            print(dateE.get(), 'Product-2',
                  p2price.get(), p2quantity.get(), price2)
            cur.execute(sql, (dateE.get(), 'Product-2',
                        p2price.get(), p2quanity.get(), price2))
            connectObj.commit()
        ...
        if p3quantity.get() != 0:
            ...
            (?, ?, ?, ?,?)
            '''
            cur.execute(sql, (dateE.get(), 'Product-3',
                        p3price.get(), p3quantity.get(), price3))
            connectObj.commit()
